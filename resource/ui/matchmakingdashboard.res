"Resource/UI/MatchMakingDashboard.res"
{
	...
	"TopBar"
	{
		...
		"ToggleChatButton"
		{
			...
			"image_armedcolor"	"235 226 202 255" // Button icon hover color
		...
		"ResumeButton"
		{
			...
			"defaultFgColor_override" "214 206 200 255" // Button text color
			"armedFgColor_override" "235 226 202 255" // Button hover text color
			...
			"SubImage"
			{
				...
				"image_armedcolor_override"	"235 226 202 255" // Button icon hover color
			}
		}
